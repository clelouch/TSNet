...
class PositioningDecoder(nn.Module):
    def __init__(self, config):
        ...
        self.compress4 = nn.Sequential(
            nn.Conv2d(2048, 64, 1, bias=False),
            norm_layer(64),
...
class Net(nn.Module):
    def __init__(self, config):
        ...
        self.compress3 = MFEM(2048, 64, nl=True)
        self.compress2 = MFEM(1024, 64)
        self.compress1 = MFEM(512, 64)
        self.compress0 = MFEM(256, 64)
    ...
    def forward(self, x):
        ...
        x2_2 = self.resnet.layer2_2(cropped_features)
